...
<body>
                ...
                <div class="categories-search-wrapper">
                    ...
                    <div class="categories-wrapper">
                        <form action="{{ route('products.search') }}" method="GET">
                            <input placeholder="Enter Your key word" type="text" name="query">
                    ...
                    <div class="best-selling-left">
                        <div class="product-wrapper">
                            <div class="product-img-4">
                                <a href="#"><img src="{{ asset('assets/img/product/electro/9.jpg') }}" alt=""></a>
                            ...
                            <div class="coustom-row-3">
                                <div class="custom-col-style-3 custom-col-3">
                                    <div class="product-wrapper mb-6">
                                        <div class="product-img-4">
                                            <a href="#">
                                                <img src="{{ asset('assets/img/product/electro/10.jpg') }}" alt="">
                                            </a>
                                            <div class="product-action-right">
                                                <a class="animate-top" title="Add To Cart" href="#">
                                                    <i class="pe-7s-cart"></i>
                                ...
                                <div class="custom-col-style-3 custom-col-3">
                                    <div class="product-wrapper mb-6">
                                        <div class="product-img-4">
                                            <a href="#">
                                                <img src="{{ asset('assets/img/product/electro/11.jpg') }}" alt="">
                                            </a>
                                            <div class="product-action-right">
                                                <a class="animate-top" title="Add To Cart" href="#">
                                                    <i class="pe-7s-cart"></i>
                                ...
                                <div class="custom-col-style-3 custom-col-3">
                                    <div class="product-wrapper mb-6">
                                        <div class="product-img-4">
                                            <a href="#">
                                                <img src="{{ asset('assets/img/product/electro/12.jpg') }}" alt="">
                                            </a>
                                            <div class="product-action-right">
                                                <a class="animate-top" title="Add To Cart" href="#">
                                                    <i class="pe-7s-cart"></i>
                                ...
                                <div class="custom-col-style-3 custom-col-3">
                                    <div class="product-wrapper mb-6">
                                        <div class="product-img-4">
                                            <a href="#">
                                                <img src="{{ asset('assets/img/product/electro/13.jpg') }}" alt="">
                                            </a>
                                            <div class="product-action-right">
                                                <a class="animate-top" title="Add To Cart" href="#">
                                                    <i class="pe-7s-cart"></i>
                                ...
                                <div class="custom-col-style-3 custom-col-3">
                                    <div class="product-wrapper mb-6">
                                        <div class="product-img-4">
                                            <a href="#">
                                                <img src="{{ asset('assets/img/product/electro/14.jpg') }}" alt="">
                                            </a>
                                            <div class="product-action-right">
                                                <a class="animate-top" title="Add To Cart" href="#">
                                                    <i class="pe-7s-cart"></i>
                                ...
                                <div class="custom-col-style-3 custom-col-3">
                                    <div class="product-wrapper mb-6">
                                        <div class="product-img-4">
                                            <a href="#">
                                                <img src="{{ asset('assets/img/product/electro/15.jpg') }}" alt="">
                                            </a>
                                            <div class="product-action-right">
                                                <a class="animate-top" title="Add To Cart" href="#">
                                                    <i class="pe-7s-cart"></i>
    ...
    <div class="androit-banner-wrapper wrapper-padding pb-175">
        <div class="container-fluid">
            <div class="androit-banner-img bg-img" style="background-image: url({{ asset('assets/img/banner/36.jpg') }})">
                ...
                <div class="phn-img">
                    <img src="{{ asset('assets/img/banner/10.png') }}" alt="">
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row">
                <div class="col-lg-6 col-xl-4">
                    <div class="product-wrapper product-wrapper-border mb-30">
                        <div class="product-img-5">
                            <a href="#">
                                <img src="{{ asset('assets/img/product/electro/16.jpg') }}" alt="">
                            </a>
                        </div>
                ...
                <div class="col-lg-6 col-xl-4">
                    <div class="product-wrapper product-wrapper-border mb-30">
                        <div class="product-img-5">
                            <a href="#">
                                <img src="{{ asset('assets/img/product/electro/17.jpg') }}" alt="">
                            </a>
                        </div>
                        <div class="product-content-7">
                            <h4><a href="#">Autel Robotics - X-Star Premium Quadcopter</a></h4>
                ...
                <div class="col-lg-6 col-xl-4">
                    <div class="product-wrapper product-wrapper-border mb-30">
                        <div class="product-img-5">
                            <a href="#">
                                <img src="{{ asset('assets/img/product/electro/18.jpg') }}" alt="">
                            </a>
                        </div>
                        <div class="product-content-7">
                            <h4><a href="#">Autel Robotics - X-Star Premium Quadcopter</a></h4>
                ...
                <div class="col-lg-6 col-xl-4">
                    <div class="product-wrapper product-wrapper-border mb-30">
                        <div class="product-img-5">
                            <a href="#">
                                <img src="{{ asset('assets/img/product/electro/19.jpg') }}" alt="">
                            </a>
                        </div>
                        <div class="product-content-7">
                            <h4><a href="#">Autel Robotics - X-Star Premium Quadcopter</a></h4>
                ...
                <div class="col-lg-6 col-xl-4">
                    <div class="product-wrapper product-wrapper-border mb-30">
                        <div class="product-img-5">
                            <a href="#">
                                <img src="{{ asset('assets/img/product/electro/20.jpg') }}" alt="">
                            </a>
                        </div>
                        <div class="product-content-7">
                            <h4><a href="#">Autel Robotics - X-Star Premium Quadcopter</a></h4>
                ...
                <div class="col-lg-6 col-xl-4">
                    <div class="product-wrapper product-wrapper-border mb-30">
                        <div class="product-img-5">
                            <a href="#">
                                <img src="{{ asset('assets/img/product/electro/21.jpg') }}" alt="">
                            </a>
                        </div>
                        <div class="product-content-7">
                            <h4><a href="#">Autel Robotics - X-Star Premium Quadcopter</a></h4>
        ...
        <div class="container-fluid">
            <div class="brand-logo-active2 owl-carousel">
                <div class="single-brand">
                    <img src="{{ asset('assets/img/brand-logo/7.png') }}" alt="">
                </div>
                <div class="single-brand">
                    <img src="{{ asset('assets/img/brand-logo/8.png') }}" alt="">
                </div>
                <div class="single-brand">
                    <img src="{{ asset('assets/img/brand-logo/9.png') }}" alt="">
                </div>
                <div class="single-brand">
                    <img src="{{ asset('assets/img/brand-logo/10.png') }}" alt="">
                </div>
                <div class="single-brand">
                    <img src="{{ asset('assets/img/brand-logo/11.png') }}" alt="">
                </div>
                <div class="single-brand">
                    <img src="{{ asset('assets/img/brand-logo/12.png') }}" alt="">
                </div>
                <div class="single-brand">
                    <img src="{{ asset('assets/img/brand-logo/13.png') }}" alt="">
                </div>
                <div class="single-brand">
                    <img src="{{ asset('assets/img/brand-logo/7.png') }}" alt="">
                </div>
